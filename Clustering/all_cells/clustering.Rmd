...
combined.sct = RunUMAP(combined.sct, reduction = "pca", dims = 1:25)
combined.sct= FindNeighbors(combined.sct, reduction = "pca", dims = 1:25)
...
combined.sct = FindClusters(combined.sct, resolution = .9)
...
```{r}
saveRDS(combined.sct,"clustered_kb_res.9_25PC.rds")
